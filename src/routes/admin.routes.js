...
router.get('/community/flagged', communityCtrl.getFlaggedContent);
router.post('/community/flag/:eventId', communityCtrl.flagContent);
router.post('/community/unflag/:eventId', communityCtrl.unflagContent);
